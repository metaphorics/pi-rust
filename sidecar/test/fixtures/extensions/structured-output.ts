/**
 * Fixture: verbatim copy of pi's corpus extension
 * `packages/coding-agent/examples/extensions/structured-output.ts`
 * (pinned 0.80.7) — a final structured-output tool whose result carries
 * `terminate: true`, exercising the AgentToolResult relay surface.
 */
